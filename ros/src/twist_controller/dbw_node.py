...
class DBWNode(object):
    def __init__(self):
        ...
        self.twist_sub = rospy.Subscriber('/twist_cmd', TwistStamped, self.twist_callback, queue_size=1)
        self.velocity_sub = rospy.Subscriber('/current_velocity', TwistStamped, self.velocity_callback, queue_size=1)
